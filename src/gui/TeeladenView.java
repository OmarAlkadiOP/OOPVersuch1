...
public class TeeladenView {
	...
	private TeeladenControl teeladenControl;

	public TeeladenView(TeesorteModel teesorteModel, TeeladenControl teeladenControl, Stage primaryStage) {
		super();
		this.teesorteModel = teesorteModel;
		this.teeladenControl = teeladenControl;
	...
	private void initListener() {
		...
		mnItmCsvImport.setOnAction(new EventHandler<ActionEvent>() {
			@Override
			public void handle(ActionEvent e) {
				teeladenControl.leseAusDatei("csv");
			}
		});
		mnItmTxtImport.setOnAction(new EventHandler<ActionEvent>() {
			@Override
			public void handle(ActionEvent e) {
				teeladenControl.leseAusDatei("txt");
			}
		});
		mnItmCsvExport.setOnAction(new EventHandler<ActionEvent>() {
			@Override
			public void handle(ActionEvent e) {
				teeladenControl.schreibeTeesInCsvDatei();
			}
		});
	}
